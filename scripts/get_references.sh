...
then  wget ftp://ftp.fernbase.org/Azolla_filiculoides/Azolla_asm_v1.1/Azolla_filiculoides.genome_v1.2.fasta \
           -O references_Azfil_v1.fasta
fi

if   [ ! -f references/Azfil_cp1.4.fasta ]
then  wget ftp://ftp.fernbase.org/Azolla_filiculoides/Azolla_asm_v1.1/chloroplast_genome/Azolla_filiculoides.cp_genome_v1_4.fasta
